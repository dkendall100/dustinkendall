...
<head>
	...
	<title>Residential Electrical Work</title>
										...
										<div class="wpb_column vc_column_container vc_col-sm-12">
											<div class="wpb_wrapper">
												<div class="sc_content main">
												  <h1 class="sc_title sc_aligncenter sc_title_regular">Residential Electrical Work</h1>
												  <div class="sc_subsection bg_tint_none sc_aligncenter margin_bottom_small">
													...
													<div class="sc_team no_padding"> </div>
											  </div>
...
<h5 class="sc_title sc_title_iconed">Hot Tubs and Pools</h5>
																	  </div>
																	</div>
																	<div class="sc_section ">
																		<div class="wpb_text_column wpb_content_element ">
																			<div class="wpb_wrapper">
																			  <p>We'll wire pools and hot tubs on your deck, 4 seasons room, and indoors. We keep everything we install up to code and safe for the whole family.</p>
																			</div>
																		</div>
																	</div>
																</a>
															...
															<div class="columns1_3 sc_column_item sc_column_item_1 odd first">
																<a href="commercial-electrician.php">
																	<div class="sc_section">
																		<div class="sc_title_icon_animated">
<h5 class="sc_title sc_title_iconed">Light Fixtures</h5>
																	  </div>
																	</div>
																	<div class="sc_section ">
																		<div class="wpb_text_column wpb_content_element ">
																			<div class="wpb_wrapper">
																				<p>Intall any type of light fixture chandelier, recessed lighting, surface lighting, under cabinent lighting, outside lighting, and architechtual lighting.</p>
																			</div>
																		</div>
																	</div>
																</a>
																...
																<a href="industrial-electrician.php">
																	<div class="sc_section">
																		<div class="sc_title_icon_animated">
																			...
																			<h5 class="sc_title sc_title_iconed">Outlets and Panels</h5>
																		</div>
																	</div>
																	<div class="sc_section ">
																		<div class="wpb_text_column wpb_content_element ">
																			<div class="wpb_wrapper">
																			  <p>We install GFCI, outdoor outlets, panels and wriing for new construction, garages and sheds. Specialty 220/120 outlets available for specialty machinery.</p>
																			</div>
																		</div>
																	</div>
																</a>
									...
									<!--<div class="vc_row wpb_row vc_row-fluid">
										<div class="wpb_column vc_column_container vc_col-sm-12">
											<div class="wpb_wrapper">
												<div class="sc_content main">
													<h1 class="sc_title sc_aligncenter sc_title_regular" data-animation="animated fadeInUp">Residential Projects</h1>
															...
															<div class="isotopeFiltr">
																<ul>
																	...
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_252">Rough In</a>
																	</li>
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_253">kitchens</a>
																	</li>
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_251">Bathrooms</a>
																	</li>
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_250">Architectural Lighting</a>
																	</li>
																</ul>
															</div>
															<section class="portfolio isotope folio3col" data-columns="3">
																<!--<article class="isotopeElement hover_Shift odd flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/roughin/meter-panel.jpg">
																	  </div>
																			<div class="info">
																				<div class="info-back">
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_251">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/bathrooms/affordable-bathroom-remodel-pictures-bathroom-remodel-ideas-small-space-master-from-modern-bathroom-remodel-electrical-lighting.jpg">
																	  </div>
																			<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
																...
																<article class="isotopeElement hover_Shift even flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																			...
																			<div class="img">
																				<img alt="Kitchen Design Ideas" src="images/residential/roughin/panel-rough-in-chesterton.jpg">
																			</div>
																			<div class="info">
																				<!--<div class="info-back">
																...
																<article class="isotopeElement hover_Shift odd flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">
-->																			<div class="img">
																				<img alt="10 Design Lessons" src="images/residential/roughin/northwestindiana-electrical.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																...
																<article class="isotopeElement hover_Shift even flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Exterior Design Ideas" src="images/residential/roughin/panel-rough-in-hammond.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_250">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/architectural/architectural-lighting-richmond.png">
																	  </div>
																			<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_251">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/bathrooms/eco_friendly_bathroom_lighting_ideas.jpg">
																	  </div>
																			<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
																...
																<article class="isotopeElement hover_Shift odd flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Interior Design Ideas" src="images/residential/roughin/residential-lighting-rough-in-valparaisoindiana.png">
																			</div>
																			<!--div class="info">
																				<div class="info-back">
																...
																<article class="isotopeElement hover_Shift even last flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/residential/roughin/valparaiso-electrical-panel.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
                                                                ...
                                                                <article class="isotopeElement hover_Shift even last flt_253">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/residential/kitchens/amazing-simple-kitchen-remodel-simple-kitchen-decorating-simple-kitchen-design-simple-kitchen-design-on-nice-kitchen.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_250">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/architectural/northwest-indiana-outdoor-lighting-architectural.jpg">
																	  </div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_251">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/bathrooms/full-bathroom-remodel-lighting.jpg">
																	  </div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift even last flt_253">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/residential/kitchens/furniture-kitchen-interior-remarkable-black-granite-dinette-countertops-combined-double-carving-legs-support-at-right-side-and-simple-three-barstool-at-the-laminate-flooring-for-kitchen-remodel-in-go.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_251">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/bathrooms/images-lighting.jpg">
																	  </div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
                                                                  ...
                                                                  <article class="isotopeElement hover_Shift even last flt_253">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/residential/kitchens/kitchen-valparaiso-electrical.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                  ...
                                                                  <article class="isotopeElement hover_Shift even last flt_253">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/residential/kitchens/simple-kitchen-remodel-on-luxury-kitchen.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                  ...
                                                                  <article class="isotopeElement hover_Shift even last flt_253">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/residential/kitchens/traditional-electrical-illiana.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_250">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/architectural/decklighting-outside.jpg">
																	  </div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_251">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/residential/bathrooms/Master-Bathroom-Remodel-electrical.jpg">
																	  </div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Living Room Staircases</h4>
