<div class="footerContentWrap">
			  <footer style="background:#CAD3DC !important" class="footerWrap footerStyleLight contactFooterWrap">
					<div class="main contactFooter">
						<section>
							...
							<div class="contactAddress">
								<address style="color:black" class="addressRight">
									Phone: 219-276-1746<br>
									
								</address>
								<address style="color:black" class="addressLeft">
									Email: sales@illianaelectrical.com<br>
								</address>
							</div>
...
<div class="copyWrap">
		  <div class="copy main">
						<div class="copyright">
							&copy; 2010 Illiana Electrical Services LLC
							
						</div>
						<div class="copy_socials socPage">
							<ul>
								<li>
									<a class="social_icons icon-facebook" target="_blank" href="https://www.facebook.com/illianaelectrical/?fref=ts">
									</a>
								</li>
						<!--		<li>
