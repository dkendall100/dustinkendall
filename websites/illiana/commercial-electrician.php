...
<head>
	...
	<title>Commercial Electrical Work</title>
										...
										<div class="wpb_column vc_column_container vc_col-sm-12">
											<div class="wpb_wrapper">
												<div class="sc_content main">
												  <h1 class="sc_title sc_aligncenter sc_title_regular">Commercial Electrical Work</h1>
...
<h5 class="sc_title sc_title_iconed">Commericial Lighting</h5>
																	  </div>
																	</div>
																	<div class="sc_section ">
																		<div class="wpb_text_column wpb_content_element ">
																			<div class="wpb_wrapper">
																			  <p>Lighting for drop ceilings, wharehouses, freezers, parking lots, and diplay cases.</p>
																			</div>
																		</div>
																	</div>
																</a>
															...
															<div class="columns1_3 sc_column_item sc_column_item_1 odd first">
																<a href="commercial-electrician.php">
																	<div class="sc_section">
																		<div class="sc_title_icon_animated">
<h5 class="sc_title sc_title_iconed">Machinery</h5>
																	  </div>
																	</div>
																	<div class="sc_section ">
																		<div class="wpb_text_column wpb_content_element ">
																			<div class="wpb_wrapper">
																				<p>Hydraulic box compactors, fork lift charging stations, wiring for restuarant and deli equipment.</p>
																			</div>
																		</div>
																	</div>
																</a>
																...
																<a href="industrial-electrician.php">
																	<div class="sc_section">
																		<div class="sc_title_icon_animated">
																			...
																			<h5 class="sc_title sc_title_iconed">UPS' and Generators</h5>
																		</div>
																	</div>
																	<div class="sc_section ">
																		<div class="wpb_text_column wpb_content_element ">
																			<div class="wpb_wrapper">
																			  <p>Uninteruptable power supplies and emergency generators can be installed for emergency operations or emergency lighting.</p>
																			</div>
																		</div>
																	</div>
																</a>
...
<div class="sc_section sc_aligncenter" data-animation="animated fadeInUp">
						<div class="sc_blogger sc_blogger_horizontal style_portfolio3 portfolioWrap">
															<div class="isotopeFiltr">
																<ul>
																	...
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_252">LED Lighting</a>
																	</li>
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_253">Metal Conduit</a>
																	</li>
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_251">Commercial Panels</a>
																	</li>
																	<li class="squareButton">
																		<a href="#" data-filter=".flt_250">Meters</a>
																	</li>
																</ul>
															</div>
														  <section class="portfolio isotope folio3col" data-columns="3">
																...
																<article class="isotopeElement hover_Shift even flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Kitchen Design Ideas" src="images/commercial/ledlighting/food-world-1b-small.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
                                                                ...
                                                                <!--<article class="isotopeElement hover_Shift even last flt_250">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/commercial/meters/comm-meter.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
															...
															<article class="isotopeElement hover_Shift even flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Exterior Design Ideas" src="images/commercial/ledlighting/commercial-electrician.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																...
																<article class="isotopeElement hover_Shift odd flt_253">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Interior Design Ideas" src="images/commercial/conduit/conduit-1.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
								  ...
								  <div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/commercial/meters/comservrev3.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<div class="img">
																				<img alt="Living Room Staircases" src="images/commercial/ledlighting/led-commercial-electrical-groceries.jpg">
																	  </div>
																			<!--<div class="info">
																				<div class="info-back">
																...
																<article class="isotopeElement hover_Shift even last flt_253">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/commercial/conduit/electrical-conduit.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift even last flt_251 flt_250">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/commercial/panels/commpanel.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
                                                                ...
                                                                <article class="isotopeElement hover_Shift odd flt_252">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="10 Design Lessons" src="images/commercial/ledlighting/commercial-led.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
                                                            ...
                                                            <article class="isotopeElement hover_Shift even last flt_251 flt_250">
																	<div class="ih-item colored square effect6 scale_up">
																		<!--<a href="#">-->
																			<div class="img">
																				<img alt="Bedroom Design Ideas" src="images/commercial/panels/electrical_panels.jpg">
																			</div>
																			<!--<div class="info">
																				<div class="info-back">
																					<h4>Bedroom Design Ideas</h4>
